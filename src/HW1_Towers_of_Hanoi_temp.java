 ...
 * following methods.
 */
public class HW1_Towers_of_Hanoi_temp<T extends Comparable<T>> {
    private HW1_Stack<Disk> rod0;
    private HW1_Stack<Disk> rod1;
    private HW1_Stack<Disk> rod2;
    private HashMap<Integer, HW1_Stack> hmap;

    public HW1_Towers_of_Hanoi_temp(HW1_Stack<Disk> rod_0, HW1_Stack<Disk> rod_1, HW1_Stack<Disk> rod_2){
        rod0 = rod_0;
        rod1 = rod_1;
        rod2 = rod_2;
        hmap = new HashMap<>();
    ...
    public static class Disk implements Comparable<HW1_Towers_of_Hanoi_temp.Disk> {
        int rod;
        int size;
